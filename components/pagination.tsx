        ...
        <div className="flex flex-col items-center justify-center gap-6 mt-16 mb-12">
            ...
            <div className="flex items-center justify-center gap-3">
                ...
                <button
                    ...
                    className="group relative p-3 rounded-xl bg-linear-to-br from-secondary to-secondary/50 hover:bg-secondary disabled:opacity-30 disabled:cursor-not-allowed transition-all duration-300 hover:scale-110 disabled:hover:scale-100"
                ...
                <div className="flex items-center gap-2 px-2">
                    {getPageNumbers().map((page, index) => (
                        <button
                            ...
                            disabled={page === "..."}
                            className={`
                relative px-3 py-2 rounded-lg font-semibold transition-all duration-300 text-sm
                ${page === currentPage
