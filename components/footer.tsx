				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
					<div className="flex flex-col gap-4 md:items-start items-center">
						<div className="text-center md:text-left">
							<h3 className="text-lg font-bold text-foreground mb-1">Built by</h3>
						...
						<p className="text-sm text-muted-foreground leading-relaxed text-center md:text-left">
							Crafting modern web experiences with a passion for gaming and
							open-source.
						</p>
					</div>
              ...
              >
				...
				<div className="border-t border-border/50 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
					<p className="text-xs text-muted-foreground">
						© {currentYear} ClaimZone - Claim Free Games & Giveaways
					</p>
					<p className="text-xs text-muted-foreground">
						Designed & Developed with <span className="text-primary">♥</span> for
						gamers
					</p>
				</div>
			</div>
