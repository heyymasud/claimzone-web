...
export const useGiveaway = () => {
	...
	const filteredGiveaways = useStore(
		useGiveawayStore,
		state => state.filteredGiveaways
	);
	...
	const paginatedGiveaways = useStore(
		useGiveawayStore,
		state => state.paginatedGiveaways
	);
	const fetchGiveaways = useStore(
		useGiveawayStore,
		state => state.fetchGiveaways
	);
	const refreshGiveaways = useStore(
		useGiveawayStore,
		state => state.refreshGiveaways
	);
	const setSelectedPlatform = useStore(
		useGiveawayStore,
		state => state.setSelectedPlatform
	);
	const setSelectedType = useStore(
		useGiveawayStore,
